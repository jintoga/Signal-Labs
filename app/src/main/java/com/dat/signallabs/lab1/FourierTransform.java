...
public class FourierTransform {
    ...
    public static List<Complex> DPF(List<Complex> f) {
    ...
    public static List<Complex> filter(List<Complex> c, int function) {
    ...
    public static ArrayList<Complex> ODPF(List<Complex> c) {
    ...
    public static ArrayList<Complex> BPF(List<Complex> f, boolean rationing) {
    ...
    public static ArrayList<Complex> BPFn(List<Complex> f) {
